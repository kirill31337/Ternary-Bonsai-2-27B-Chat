...
public final class LocalBenchmark {
 ...
 public static String runtimeInfo(File files){
  StringBuilder s=new StringBuilder("CPU backend выбирается самим Prism по возможностям CPU. Частоты и термозащита не изменяются.\n");
